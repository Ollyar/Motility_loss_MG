...
axes[0].text(-30, max(pre_2007_proportions) * 0.95, "A)", fontsize=20, fontweight='bold')  # Add "A)" label
...
axes[1].text(-30, max(pre_2007_proportions) * 0.95, "B)", fontsize=20, fontweight='bold')  # Add "B)" label
